//
//  ASSFCardIssuanceViewController.swift
//  VPD
//
//  Created by Ikenna Udokporo on 28/06/2020.
//  Copyright © 2020 voguepay. All rights reserved.
//

import UIKit

class ASSFCardIssuanceViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var expDateTextField: DesignableUITextField!
    ...
    @IBAction func issueCardButtonPressed(_ sender: Any) {
        if userAccountNumberTextField.text == "" || userNameTextField.text == "" || cardNumberTextField.text == "" || expDateTextField.text == "" {
